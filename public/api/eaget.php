...
$beginnDate = new DateTime($_POST['datum'].'-18');
$beginnDate->sub(new DateInterval('P1M'));
$endDate = new DateTime($_POST['datum'].'-17');
...
$sumSql = "SELECT SUM(arbeitszeit) AS arbeitszeit, SUM(gehalt) AS gehalt, COUNT(DISTINCT datum) AS datum FROM zeiten WHERE ahid = :id AND datum BETWEEN :beginnDate AND :endDate";
